...
- Drawbar is a V/A-frame (two arms converging at the coupling, ~1000 mm reach); a single central beam is a known-rejected design.
- Zig-zag (offset) bolt patterns along tubes — never a straight line of holes.
- Gas stays right side / electrical left side; the corner "cable tunnel" radius must stay ≥ the LMR coax bend radius (~80 mm).
