...
- Drawbar is a SINGLE central beam, VKR 100x50x4 standing on edge (~1000 mm reach), lapped under the frame to the axle crossbeam — sizing in frame.scad header and scripts/beam_check.py. (The V/A-frame is a preserved alternative, `drawbar_wedge_plate.scad`.)
