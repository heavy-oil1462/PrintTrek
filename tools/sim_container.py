#!/usr/bin/env python3
"""PrintTrek sim container manager — a simulated trailer against YOUR stack.
...
discovery, indistinguishable from hardware.
    ...
    python3 tools/sim_container.py run --broker 192.168.1.10 \
        --username printtrek --password secret
...
def main() -> int:
    ...
    run_p.add_argument("--root", default="printtrek", help="MQTT topic root")
    run_p.add_argument("--node", default="printtrek-sim")
    ...
    for p in sub.choices.values():
        p.add_argument("--name", default="printtrek-sim",
                       help="container name (default: printtrek-sim)")
